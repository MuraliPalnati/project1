$(document).ready(function () {
 ...
 { name: 'WORK_POOL_FROM', index: 'WORK_POOL_FROM', classes: 'cell', stype: 'text', editable: false },
    ...
    var colModelRight = [
        { name: 'QUANTITY_FROM', index: 'QUANTITY_FROM', classes: 'cell', stype: 'decimal', formatter: 'number', formatoptions: { decimalSeparator: ".", decimalPlaces: 1, defaultValue: '0.0' }, editable: false },
    ...
    mctrObj.CreateJqGrid('leftPanelGrid', '/MctrOhFormBl/mctrOhMctrOhOnLoadTo', 'GET', { MctrNo: mctrno, lineNo: lineNo }, columnNames, colModel, false, 'SETID', [], 100, '100%', 'desc', false);
    mctrObj.CreateJqGrid('middlePanelGrid', '/MctrOhFormBl/mctrOhMctrOhOnLoadTo', 'GET', { MctrNo: mctrno, lineNo: lineNo }, columnNamesMiddle, colModelMiddle, false, 'SETID', [], 100, '100%', 'desc', false);
    mctrObj.CreateJqGrid('rightPanelGrid', '/MctrOhFormBl/mctrOhMctrOhOnLoadTo', 'GET', { MctrNo: mctrno, lineNo: lineNo }, columnNamesRight, colModelRight, false, 'SETID', [], 100, '100%', 'desc', false);
