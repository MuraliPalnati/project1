...
{
    public partial class OrignatorSort : System.Web.UI.Page
    {
        ...
        private void BindReportViewer(string selectedORIG_BU)
        {
            ...
            this.ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/ReportFiles/OriginatorSort.rdlc");
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportMCTR reportDataSet = new ReportMCTR();
            reportDataSet = getOpenStatusSortData(selectedORIG_BU);

            ReportDataSource rds = new ReportDataSource("dsOriginatorSort", reportDataSet.Tables[reportDataSet.dtOriginatorSort.TableName]);
        ...
        private ReportMCTR getOpenStatusSortData(string selectedORIG_BU)
        {
            ...
            try
            {
                return reportsUtil.GenerateReportsData(sql, reportDataSet, reportDataSet.dtOriginatorSort.TableName);
            }
            catch (Exception)
            {
