...
{
    public class MctrLineiteminquiry
    {
        public MctrLineiteminquiry()
        {
            this.MCTR_OVRHD = new HashSet<MctrOverhd>();
            this.MCTR_PER_BACKUP = new HashSet<MctrPerBackup>();
            this.MCTR_TTD_BACKUP = new HashSet<MctrTtdBackup>();
        }
        ...
        public virtual ICollection<MctrOverhd> MCTR_OVRHD { get; set; }
        public virtual ICollection<MctrPerBackup> MCTR_PER_BACKUP { get; set; }
        public virtual ICollection<MctrTtdBackup> MCTR_TTD_BACKUP { get; set; }
        //MctrRpMasterV
