$(document).ready(function () {
    jQuery("#JrnlipGrid").jqGrid({
        ...
        colModel: [
            ...
            { key: false, name: 'LINE_NO_OH', index: 'LINE_NO_OH', classes: 'cell', stype: 'short', width: 50, editable: false, frozen: true },
            { key: false, name: 'INTFC_LINE_NUM', index: 'INTFC_LINE_NUM', classes: 'cell', stype: 'decimal',  editable: false },
            ...
            { key: false, name: 'ANALYSIS_TYPE', index: 'ANALYSIS_TYPE', classes: 'cell uppercase', stype: 'text', editable: false },
            ...
            { key: false, name: 'TRANS_DT', index: 'TRANS_DT', classes: 'cell', stype: 'text', formatter: 'date', formatoptions: { srcformat: 'd/m/Y', newformat: 'Y-m-d' }, editable: false },
            { key: false, name: 'ACCOUNTING_DT', index: 'ACCOUNTING_DT', classes: 'cell', formatter: 'date', formatoptions: { srcformat: 'd/m/Y', newformat: 'Y-m-d' }, editable: false },
            { key: false, name: 'DTTM_STAMP', index: 'DTTM_STAMP', formatter: 'date', formatoptions: { srcformat: 'd/m/Y', newformat: 'Y/m/d' }, classes: 'cell', editable: false },
            ...
            { key: false, name: 'FOREIGN_AMOUNT', index: 'FOREIGN_AMOUNT', stype: 'decimal', formatter: 'number', formatoptions: { decimalSeparator: ".", decimalPlaces: 2, defaultValue: '0.00' }, classes: 'cell ',align: "right", editable: false },
            { key: false, name: 'RATE_MULT', index: 'RATE_MULT', classes: 'cell', stype: 'decimal', formatter: 'number', formatoptions: { decimalSeparator: ".", decimalPlaces: 8, defaultValue: '0.00000000' }, editable: false },
            { key: false, name: 'CUR_EFFDT', index: 'CUR_EFFDT', classes: 'cell', formatter: 'date', formatoptions: { srcformat: 'd/m/Y', newformat: 'Y/m/d' }, editable: false },
            { key: false, name: 'PROCESS_INSTANCE', index: 'PROCESS_INSTANCE', stype: 'integer',align: "right", classes: 'cell', editable: false },
            ...
            { key: false, name: 'VOUCHER_LINE_NUM', index: 'VOUCHER_LINE_NUM', classes: 'cell',align: "right", stype: 'decimal', editable: false },
            ...
            { key: false, name: 'RESOURCE_QUANTITY', index: 'RESOURCE_QUANTITY', classes: 'cell', stype: 'decimal',align: "right", editable: false },
            { key: false, name: 'RESOURCE_AMOUNT', index: 'RESOURCE_AMOUNT', classes: 'cell', stype: 'decimal',align: "right", formatter: 'number', formatoptions: { decimalSeparator: ".", decimalPlaces: 2, defaultValue: '0.00' }, editable: false },
            ...
            { key: false, name: 'ACCOUNTING_PERIOD', index: 'ACCOUNTING_PERIOD', classes: 'cell', stype: 'decimal',align: "right", editable: false },
            { key: false, name: 'DUE_DATE', index: 'DUE_DATE', formatter: 'date', formatoptions: { srcformat: 'd/m/Y', newformat: 'Y/m/d' }, classes: 'cell', editable: false },
            { key: false, name: 'FISCAL_YEAR', index: 'FISCAL_YEAR', classes: 'cell', stype: 'decimal',align: "right", editable: false },
            { key: false, name: 'FC_TRANSLATION_CD7', index: 'FC_TRANSLATION_CD7', classes: 'cell', stype: 'text', editable: false },
            { key: false, name: 'VARIABLE_DT7', index: 'VARIABLE_DT7', classes: 'cell', formatter: 'date', formatoptions: { srcformat: 'd/m/Y', newformat: 'Y/m/d' }, editable: false },
            ...
            { key: false, name: 'RES_DETAIL_ID7', index: 'RES_DETAIL_ID7', classes: 'cell', stype: 'decimal',align: "right", editable: false },
    { key: false, name: 'GROUPBYNUM', index: 'GROUPBYNUM', stype: 'decimal', classes: 'cell',align: "right", editable: false }],
        pager: jQuery('#pager'),
        rowNum: 10,
        height: '100%',
        viewrecords: true,
    ...
    jQuery("#JrnlipGrid").jqGrid('navGrid', '#pager', {
        add: false,
        edit: false,
        del: false,
        search: true,
    ...
    jQuery("#JrnlipGrid").jqGrid('setFrozenColumns');
});