$(document).ready(function () {
    ...
    mctrObj.CreateJqGrid('mctrActiveProjectsGrid', '/MctrCreateForm/getRgProjToLOVJson', 'GET', { activityIdTo: $('#' + $('#activeProgFrom').val() + '_ACTIVITY_ID_TO').val(), periodTo: $('#PeriodTo').val(), cow: $('#COW').val() }, columnNames, colModel, false, '', [], 10, '100%', 'desc', selectRowFn);
    $("#mctrActiveProjectsGrid").navGrid('#pager', { add: false, edit: false, del: false, search: false, refresh: true }, {}, {}, {}, {});
    $('#activeProjTookBtn').click(function () {
        ...
        $('#' + rowID + '_ACCOUNT_TO').attr('value', rowObject.ACCOUNT);
        ...
        $('#' + rowID + '_BUM_CD7_TO').val(rowObject.BUS_UNIT_MGMT_CD7);
        $('#' + rowID + '_BUM_CD7_TO').attr('value',rowObject.BUS_UNIT_MGMT_CD7);
