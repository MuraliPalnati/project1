$(document).ready(function () {
 ...
 { name: 'WORK_POOL_FROM', index: 'WORK_POOL_FROM', classes: 'cell', stype: 'text', editable: false },
    ...
    mctrObj.CreateJqGrid('leftPanelGrid', '/MctrOhFormBl/mctrOverheadOnload', 'GET', { MctrNo: mctrno }, columnNames, colModel, false, 'SETID', [], 100, '100%', 'desc', false);
    mctrObj.CreateJqGrid('middlePanelGrid', '/MctrOhFormBl/mctrOverheadOnload', 'GET', { MctrNo: mctrno }, columnNamesMiddle, colModelMiddle, false, 'SETID', [], 100, '100%', 'desc', false);
    mctrObj.CreateJqGrid('rightPanelGrid', '/MctrOhFormBl/mctrOverheadOnload', 'GET', { MctrNo: mctrno }, columnNamesRight, colModelRight, false, 'SETID', [], 100, '100%', 'desc', false);
