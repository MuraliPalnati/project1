$(document).ready(function () {
    ...
    var selectRowFn = function (rowid, status, obj) {
        var rowData = $('#ListWorkLocFromGrid').jqGrid('getRowData', rowid);
        rowObject = rowData;
    };
    ...
    mctrObj.CreateJqGrid('ListWorkLocFromGrid', '/MctrCreateForm/getRgListWorkLocFromLOVJson', 'POST', mctrLineItem, columnNames, colModel, false, '', [], 10, '100%', 'desc', selectRowFn);
    $("#ListWorkLocFromGrid").navGrid('#pager', { add: false, edit: false, del: false, search: false, refresh: true }, {}, {}, {}, {});
    $('#ListWorkLocFromOkBtn').click(function () {
        ...
        var dept_status = '';
        if ((work_loc_from == '' && global_work_loc_from != '') || (!$.isEmptyObject(rowObject))) {
    ...
    mctrObj.searchGrid('ListWorkLocFromGrid');
});